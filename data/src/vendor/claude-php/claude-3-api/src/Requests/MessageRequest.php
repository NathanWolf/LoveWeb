...
class MessageRequest
{
    ...
    public function __construct(Config $config)
    {
        ...
        $this->cacheControl = $config->getCacheControl() ?? Config::DEFAULT_CACHE_CONTROL;
    }
    ...
    public function setCacheControl(?float $cacheControl): self
    {
    ...
    public function toArray(): array
    {
        ...
        if ($this->cacheControl) {
            $data['cache_control'] = array(
                'type' => $this->cacheControl
            );
        }
